...
// Function for Team Bios

	$('.m-team-picture').click(function() {
		$('.m-team').find('.s-active').removeClass('s-active');

		var name = $(this).attr('id').slice(5);
...
// Signup Hide Function
	...
	$('.signup-handle').click(function() {
	    $('#mc_embed_signup').toggleClass('s-disabled');
	});
