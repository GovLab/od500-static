...
BLOG_AUTHOR = "The GovLab"  # (translatable)
BLOG_TITLE = "Open Data 500"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://www.opendata500.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://www.opendata500.com/"
BLOG_EMAIL = "admins@thegovlab.org"
BLOG_DESCRIPTION = "The OD500 Global Network"  # (translatable)
...
NAVIGATION_LINKS = {
    ...
    "it": (
        ...
        ("/it/categories/index.html", "Tags"),
        ("/it/rss.xml", "Flusso RSS"),
    ),
